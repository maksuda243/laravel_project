...
@section('title', trans('updated profile'))
        ...
        <div class="col-lg-10 offset-lg-2">
            <div class="card">
                <div class="card-header">
                    <h4>{{ trans('updated profile') }}</h4>
                    <div class="card-Posted Job Listheader-action">
                        <a href="{{ route('jobseeker_profile.create'') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('jobseeker_profile.edit'', encryptor('encrypt', $p->id)) }}" class="btn btn-sm btn-warning">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="javascript:void(0)" onclick="deleteUser('{{ $p->id }}')" class="btn btn-sm btn-danger">
                                            <i class="fa fa-trash"></i>
                                        </a>
                                        <form id="delete-form-{{ $p->id }}" action="{{ route('jobseeker_profile.destroy', encryptor('encrypt', $p->id)) }}" method="post" style="display: none;">
                                            @csrf
                                            @method('delete')
                                        </form>
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="8" class="text-center">{{ __('No profile Found') }}</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>

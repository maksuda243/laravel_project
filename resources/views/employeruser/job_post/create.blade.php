                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea id="requirments" class="form-control summernote" name="requirments">{{ old('requirments') }}</textarea>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <textarea id="special_instruction" class="form-control summernote" name="special_instruction">{{ old('special_instruction') }}</textarea>

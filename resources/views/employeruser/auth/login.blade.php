                                ...
                                <div class="main-menu">
                                    <nav class="d-none d-lg-block">
                                        <ul id="navigation">
                                            ...
                                            <li><a href="{{url('/service')}}">Services for Employer</a></li>
                                            <li><a href="{{url('/contact')}}">Post a Job</a></li>
                                        </ul>
                                    </nav>
                                </div> 
                            </div>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            ...
            {{-- <div class="d-flex justify-content-center align-items-center">
                <a href="#" class="mr-4">
                    <button class="btn btn-dark btn-lg">Services for Employers</button>
                </a>
                <a href="#" class="mr-4">
                    <button class="btn btn-dark btn-lg">Post a New Job Now</button>
                </a>
            </div> --}}
            <br>
